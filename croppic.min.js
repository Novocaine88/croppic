...
onAfterImgCrop:null,onError:null};for(var c in b)this.options[c]=b[c];this.init()};Croppic.prototype={id:"",imgInitW:0,imgInitH:0,imgW:0,imgH:0,objW:0,objH:0,actualRotation:0,windowW:0,windowH:$(k).height(),obj:{},outputDiv:{},outputUrlObj:{},img:{},defaultImg:{},croppedImg:{},imgEyecandy:{},form:{},cropControlsUpload:{},cropControlsCrop:{},cropControlZoomMuchIn:{},cropControlZoomMuchOut:{},cropControlZoomIn:{},cropControlZoomOut:{},cropControlCrop:{},cropControlReset:{},cropControlRemoveCroppedImage:{},
...
a.cropControlCrop=a.cropControlsCrop.find(".cropControlCrop");a.cropControlCrop.on("click",function(){a.crop()});a.cropControlReset=a.cropControlsCrop.find(".cropControlReset");a.cropControlReset.on("click",function(){a.reset()})},initDrag:function(){var a=this;a.img.on("mousedown touchstart",function(b){b.preventDefault();var c,d=k.navigator.userAgent;d.match(/iPad/i)||d.match(/iPhone/i)||d.match(/android/i)?(c=b.originalEvent.touches[0].pageX,b=b.originalEvent.touches[0].pageY):(c=b.pageX,b=b.pageY);
var e=a.img.css("z-index"),f=a.img.outerHeight(),h=a.img.outerWidth(),g=a.img.offset().top+f-b,l=a.img.offset().left+h-c;a.img.css("z-index",1E3).on("mousemove touchmove",function(b){var c;d.match(/iPad/i)||d.match(/iPhone/i)||d.match(/android/i)?(c=b.originalEvent.touches[0].pageY+g-f,b=b.originalEvent.touches[0].pageX+l-h):(c=b.pageY+g-f,b=b.pageX+l-h);a.img.offset({top:c,left:b}).on("mouseup",function(){$(this).removeClass("draggable").css("z-index",e)});a.options.imgEyecandy&&a.imgEyecandy.offset({top:c,
left:b});a.objH<a.imgH?(0<parseInt(a.img.css("top"),10)&&(a.img.css("top",0),a.options.imgEyecandy&&a.imgEyecandy.css("top",0)),c=-(a.imgH-a.objH),parseInt(a.img.css("top"),10)<c&&(a.img.css("top",c),a.options.imgEyecandy&&a.imgEyecandy.css("top",c))):(0>parseInt(a.img.css("top"),10)&&(a.img.css("top",0),a.options.imgEyecandy&&a.imgEyecandy.css("top",0)),c=a.objH-a.imgH,parseInt(a.img.css("top"),10)>c&&(a.img.css("top",c),a.options.imgEyecandy&&a.imgEyecandy.css("top",c)));a.objW<a.imgW?(0<parseInt(a.img.css("left"),
10)&&(a.img.css("left",0),a.options.imgEyecandy&&a.imgEyecandy.css("left",0)),c=-(a.imgW-a.objW),parseInt(a.img.css("left"),10)<c&&(a.img.css("left",c),a.options.imgEyecandy&&a.imgEyecandy.css("left",c))):(0>parseInt(a.img.css("left"),10)&&(a.img.css("left",0),a.options.imgEyecandy&&a.imgEyecandy.css("left",0)),c=a.objW-a.imgW,parseInt(a.img.css("left"),10)>c&&(a.img.css("left",c),a.options.imgEyecandy&&a.imgEyecandy.css("left",c)));a.options.onImgDrag&&a.options.onImgDrag.call(a)})}).on("mouseup",
...
"deg)"});"function"==typeof this.options.onImgRotate&&this.options.onImgRotate.call(this)},zoom:function(a){var b=this.imgW/this.imgH,c=this.imgW+a,d=c/b,e=!0;if(c<this.objW||d<this.objH)c-this.objW<d-this.objH?(c=this.objW,d=c/b):(d=this.objH,c=b*d),e=!1;!this.options.scaleToFill&&(c>this.imgInitW||d>this.imgInitH)&&(c-this.imgInitW<d-this.imgInitH?(c=this.imgInitW,d=c/b):(d=this.imgInitH,c=b*d),e=!1);this.imgW=c;this.img.width(c);this.imgH=d;this.img.height(d);b=parseInt(this.img.css("top"),10)-
a/2;a=parseInt(this.img.css("left"),10)-a/2;0<b&&(b=0);0<a&&(a=0);var f=-(d-this.objH);b<f&&(b=f);f=-(c-this.objW);a<f&&(a=f);e&&this.img.css({top:b,left:a});this.options.imgEyecandy&&(this.imgEyecandy.width(c),this.imgEyecandy.height(d),e&&this.imgEyecandy.css({top:b,left:a}));this.options.onImgZoom&&this.options.onImgZoom.call(this)},crop:function(){var a=this;a.options.onBeforeImgCrop&&a.options.onBeforeImgCrop.call(a);a.cropControlsCrop.hide();a.showLoader();var b={imgUrl:a.imgUrl,imgInitW:a.imgInitW,
imgInitH:a.imgInitH,imgW:a.imgW,imgH:a.imgH,imgY1:Math.abs(parseInt(a.img.css("top"),10)),imgX1:Math.abs(parseInt(a.img.css("left"),10)),cropH:a.objH,cropW:a.objW,rotation:a.actualRotation},c=new FormData,d;for(d in b)b.hasOwnProperty(d)&&c.append(d,b[d]);for(d in a.options.cropData)a.options.cropData.hasOwnProperty(d)&&c.append(d,a.options.cropData[d]);$.ajax({url:a.options.cropUrl,data:c,context:g.body,cache:!1,contentType:!1,processData:!1,type:"POST"}).always(function(b){response="object"==typeof b?
